...
public interface BookDAO {
	 ...
	 * @return
	 */
	public abstract long getTotalBookNumber(BookCriteria cb);
	 ...
	 * @return
	 */
	public abstract List<Book> getPageList(BookCriteria cb);
	 ...
	 * @return
	 */
	public abstract int getStoreNumber(long id);
